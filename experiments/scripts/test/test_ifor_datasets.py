...
datasets_algorithm_name: str = 'ifor'
datasets_type: str = 'stationary'
datasets_name: list = [
                       'Http',         # Http: N = 567497, d = 3, prop_anomalies = 0.4%
                       'ForestCover',  # ForestCover: N = 286048, d = 10, prop_anomalies = 0.9%
                       'Mulcross',     # Mulcross: N = 262144, d = 4, prop_anomalies = 10%
                       'Smtp',         # Smtp: N = 95156, d = 3, prop_anomalies = 0.03%
                       'Shuttle',      # Shuttle: N = 49097, d = 9, prop_anomalies = 7%
                       'Mammography',  # Mammography: N = 11183, d = 6, prop_anomalies = 2%
                       'Annthyroid',   # Annthyroid: N = 6832, d = 6, prop_anomalies = 7%
                       'Satellite'     # Satellite: N = 6435, d = 36, prop_anomalies = 32%
                       ]
