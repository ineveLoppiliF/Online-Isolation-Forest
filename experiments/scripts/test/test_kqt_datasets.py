...
datasets_algorithm_name: str = 'kqt'
datasets_type: str = 'non-stationary'
datasets_name: list = [
                       'insects_ae-aegypti-female_cx-quinq-male_ae-albopictus-male',  # insects: N = 212514, d = 33, prop_anomalies = 5.5%
                       ]
...
for j, dataset_name in enumerate(datasets_name[::-1]):
    ...
    ifasd_results: dict = {'scores': [],
                           'roc_aucs_cumulative': [],
                           'roc_aucs_windows': [],
                           'roc_aucs_holdout': [],
                           'train_times': [],
                           'test_times': []}
    hst_results: dict = {'scores': [],
                         'roc_aucs_cumulative': [],
                         'roc_aucs_windows': [],
                         'roc_aucs_holdout': [],
                         'train_times': [],
                         'test_times': []}
    rrcf_results: dict = {'scores': [],
                          'roc_aucs_cumulative': [],
                          'roc_aucs_windows': [],
                          'roc_aucs_holdout': [],
                          'train_times': [],
                          'test_times': []}
    loda_results: dict = {'scores': [],
                          'roc_aucs_cumulative': [],
                          'roc_aucs_windows': [],
                          'roc_aucs_holdout': [],
                          'train_times': [],
                          'test_times': []}
    oif_results: dict = {'scores': [],
                         'roc_aucs_cumulative': [],
                         'roc_aucs_windows': [],
                         'roc_aucs_holdout': [],
                         'train_times': [],
    ...
    for i in range(n_executions):
        ...
        ifasd_results['scores'].append(ifasd_scores)
        ...
        hst_results['scores'].append(hst_scores)
        ...
        rrcf_results['scores'].append(rrcf_scores)
        ...
        loda_results['scores'].append(loda_scores)
        ...
        oif_results['scores'].append(oif_scores)
